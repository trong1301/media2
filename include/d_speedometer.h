#ifndef D_SPEEDOMETER_H
#define D_SPEEDOMETER_H
...
class d_speedometer : public QQuickPaintedItem {
    qreal m_SpeedometerSize;
    qreal m_StartAngle;
    qreal m_AlignAngle;
    qreal m_LowestRange;
    qreal m_HighestRange;
    qreal m_HighestSpeed;
    qreal m_Speed;
    int m_ArcWidth;
    QColor m_OuterColor;
    QColor m_InnerColor;
...
public:
    ...
    explicit d_speedometer(QQuickItem* parent = 0, std::shared_ptr<sdl::GuiController> guiCtrl = nullptr);
    void paint(QPainter *painter);                  //not using virtual like instruction
